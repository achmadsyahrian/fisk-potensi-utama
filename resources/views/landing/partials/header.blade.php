                        ...
                        <div class="classynav">
                            <ul>
                                ...
                                <li><a href="#">{{__('partials/navbar.navbar.academy')}}</a>
                                    <ul class="dropdown">
                                        <li><a href="{{route('landing.academic.international')}}">{{__('partials/navbar.navbar.international')}}</a></li>
                                        <li><a href="{{route('landing.academic.english')}}">{{__('partials/navbar.navbar.english')}}</a></li>
                                    </ul>
                                </li>
                                <li>
